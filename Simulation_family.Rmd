...
simulation = function (filename, h_sq=0.5, n_sib = 0, C=1000, K=0.05, N=1e5, M=1e5, block_size=1000) {
  ...
  G_l = G_func(filename, beta, MAF, n_sib = n_sib, N, M, block_size)
  G = G_l$G
  l_g_p1 = G_l$l_g_p1
  l_g_p2 = G_l$l_g_p2
  l_g_e = liabilities_func(G, MAF, beta, n_sib = n_sib, N, h_sq, block_size)
  l_g_0 = l_g_e$l_g_0
  l_e_0 = l_g_e$l_e_0
  l_e_p1 = l_g_e$l_e_p1
  l_e_p2 = l_g_e$l_e_p2
  ...
  obj.bigsnp_LTFH = list(genotypes = G, # genotypes, FBM object
                  ...
                  fam = tibble(FID = 1:nrow(G), l_g_0, l_e_0, l_g_p1, l_g_sibs, l_e_p1, l_g_p2,
                               l_e_p2, l_e_sibs)) # fam, i.e. info on individuals
  }
  else{
  obj.bigsnp_LTFH = list(genotypes = G, # genotypes, FBM object
                  map = tibble(snp = 1:ncol(G), MAF, beta), # map, i.e. SNP info
                  fam = tibble(FID = 1:nrow(G), l_g_0, l_e_0, l_g_p1, l_e_p1, l_g_p2,
                               l_e_p2))   
  }
