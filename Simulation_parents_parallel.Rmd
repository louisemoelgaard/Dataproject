...
G_func = function(filename, beta, MAF, n_sib = 0, N=1e5, M=1e5, block_size=1000){
  ...
  out = tibble('l_g1_partial'=l_g_p1, 'l_g2_partial'=l_g_p2, "l_g_sibs" = l_g_sibs)
  return(out)
  }, future.seed = TRUE) %>% 
...
#plan("multisession")
k = G_func(filename = "test", beta = beta_, MAF = MAF, n_sib = 2, N = 100, block_size = 10, M = 100)
k$liabilities
```
