...
```{r}
# Make G
G_func_fam = function(filename, beta, MAF, fam = TRUE, n_sib = 0, N=1e5, M=1e5, block_size=1000){
...
```{r}
simulation("test4", C=100, N=1000, M=1000, n_sib = 2, block_size = 1000)
```
```{r}
snp_attach("test4.rds")
```
